...
export const createAssignment = async (req, res) => {
  try {
    ...
    // After saving, re-fetch and populate the assignment to ensure the client receives
    // the full course and batch objects, not just their IDs.
...
export const getAssignments = async (req, res) => {
  try {
    ...
    // Populate the referenced fields 'course', 'batch', and 'teacher' to return the full objects.
