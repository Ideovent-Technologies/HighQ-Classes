...
// import { Textarea } from "@/components/ui/textarea";
// import { Button } from "@/components/ui/button";
// import contactImage from "@/assets/pngtree-3d-cartoon-male-call-center-character-png-image_15984127.png";

// export default function Contact() {
//   return (
//     <div className="w-full">
//       {/* Top Section */}
//       <div className="bg-[#07116d] text-white py-16 px-4 md:px-20 text-center">
//         <h1 className="text-4xl font-bold mb-4">Get in Touch</h1>
//         <p className="text-lg max-w-2xl mx-auto">
//           Whether you're a new or existing customer, we'd love to hear from you. Select a topic below to get started.
//         </p>
//       </div>
...
//             <div
//               key={i}
//               className="bg-white p-6 rounded-xl shadow-md hover:shadow-[0_8px_0px_0px_#f97316] transition duration-300"
//             >
//               <h3 className="text-xl font-semibold mb-2">{card.title}</h3>
//               <p className="mb-4 text-sm">{card.desc}</p>
//               <a href="#" className="text-blue-600 font-medium hover:underline">
...
//       <div className="bg-white py-16 px-4 md:px-20 grid md:grid-cols-2 gap-10 items-center">
//         <div>
//           <h2 className="text-3xl font-bold mb-4 text-[#07116d]">Send Us a Message</h2>
//           <p className="mb-6 text-gray-600">Have a question or need help? Fill out the form and our team will get back to you shortly.</p>
...
//           <img src={contactImage} alt="Contact" className="max-w-md w-full" />
//         </div>
//       </div>
//     </div>
//   );
