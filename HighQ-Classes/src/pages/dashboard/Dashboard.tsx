...
import { BookOpen, Clock, Users, Bell, FileText, DollarSign } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{studentData?.batch || "Not assigned"}</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
            <CardTitle className="text-sm font-medium">Admission ID</CardTitle>
            <FileText className="h-4 w-4 text-navy-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{studentData?.admissionDetails?.admissionId || "N/A"}</div>
            <p className="text-xs text-gray-500">Joined: {studentData?.admissionDetails?.joiningDate || "N/A"}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{calculateFeePercentage()}% Paid</div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="border-l-4 border-navy-500 pl-4 py-1">
                <p className="font-medium">Physics test postponed</p>
                <p className="text-sm text-gray-600">The physics test scheduled for tomorrow has been postponed to next week.</p>
                <p className="text-xs text-gray-500 mt-1">Posted 2 hours ago</p>
              </div>
              
              <div className="border-l-4 border-navy-500 pl-4 py-1">
                <p className="font-medium">New study materials available</p>
                <p className="text-sm text-gray-600">New chemistry notes have been uploaded. Check the study materials section.</p>
                <p className="text-xs text-gray-500 mt-1">Posted yesterday</p>
              </div>
              
              <div className="text-center mt-4">
                <Link to="/dashboard/notices" className="text-sm text-navy-600 hover:text-navy-800">
                  View all notices
                </Link>
              </div>
            </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Link to="#" className="text-sm text-navy-600 hover:text-navy-800">
                  View
                </Link>
              </div>
              ...
              <div className="text-center mt-4">
                <Link to="/dashboard/upload-materials" className="text-sm text-navy-600 hover:text-navy-800">
                  Upload new material
                </Link>
              </div>
            </div>
