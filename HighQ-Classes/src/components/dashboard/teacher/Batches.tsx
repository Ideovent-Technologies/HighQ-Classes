...
const AdminAnnouncementPage: React.FC = () => {
  ...
  const totalThisMonth = announcements.filter((a) => {
    const now = new Date();
    return a.createdAt.getMonth() === now.getMonth() && a.createdAt.getFullYear() === now.getFullYear();
  }).length;
  const totalScheduled = announcements.filter((a) => a.isScheduled).length;
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: "all" | "students" | "teachers" | "batch") =>
              ...
              {/* Conditional rendering for batch selection would go here */}
