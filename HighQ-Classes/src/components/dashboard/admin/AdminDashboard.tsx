...
const AdminDashboard = () => {
  ...
  // Corrected: Imported `Variants` from 'framer-motion' to explicitly type the object
  ...
  // Add the required gradientFrom and gradientTo properties here
  const statCards = [
    {
  ...
  return (
    // Corrected the top-level motion component to wrap everything
    <motion.div
      className="p-6 space-y-8 max-w-7xl mx-auto bg-slate-50 dark:bg-slate-900 rounded-lg"
    ...
    >
      <header>
        ...
        <p className="text-slate-500 dark:text-slate-400 mt-1">
          Welcome back, Admin. Here's a summary of your institution's status.
        </p>
      </header>
